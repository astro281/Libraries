...
-- Library functions 
    ...
    -- Library element functions
        function library:window(properties)
            ...
            local menu_tweening = false

            local mobile_button = library:create("TextButton", {
                Parent = library["items"];
                Size = dim2(0, 50, 0, 50);
                Position = dim2(0, 10, 0.5, -25);
            ...
            }); library:apply_theme(mobile_button, "accent", "TextColor3")

            library:create("UICorner", {Parent = mobile_button; CornerRadius = dim(0, 10)})
            library:create("UIStroke", {Parent = mobile_button; Color = rgb(44, 44, 50); ApplyStrokeMode = Enum.ApplyStrokeMode.Border})

            library:draggify(mobile_button)
